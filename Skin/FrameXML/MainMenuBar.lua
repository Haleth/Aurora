...
function private.FrameXML.MainMenuBar()
    ...
    --_G.MainMenuXPBarTextureLeftCap:SetSize(14, 14)
    --_G.MainMenuXPBarTextureRightCap:SetSize(14, 14)
    --_G.MainMenuXPBarTextureMid:SetSize(14, 14)
    ...
    --_G.MainMenuBarLeftEndCap:SetSize(128, 128)
    --_G.MainMenuBarLeftEndCap:SetPoint("BOTTOM", -544, 0)
    --_G.MainMenuBarRightEndCap:SetSize(128, 128)
    --_G.MainMenuBarRightEndCap:SetPoint("BOTTOM", 544, 0)
